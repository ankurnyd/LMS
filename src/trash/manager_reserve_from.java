 ...
 * @author Pro
 */
public class manager_reserve_from extends javax.swing.JFrame {
 Connection con=null;
 Statement stmt=null;
 ResultSet rs=null;
 ...
 ResultSet rs1=null;
 /**
     * Creates new form manager_reserve_from
     */
    public manager_reserve_from() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Agree the the terms and Conditions ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Class.forName("java.sql.Driver");
             ...
             String query="select * from rooms where room_no="+jTextField1.getText()+";";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Class.forName("java.sql.Driver");
             ...
             String ava=jTextField4.getText();
             int roomrate=Integer.parseInt(jTextField3.getText());
             ...
             int phone=Integer.parseInt(jTextField12.getText());
             String email=jTextField13.getText();
             int bookingDate=Integer.parseInt(jTextField5.getText());
             int arrivingDate=Integer.parseInt(jTextField6.getText());
//             int departureDate=Integer.parseInt(jTextField7.getText());
             int noOfDays =Integer.parseInt(jTextField8.getText());
             int adv=Integer.parseInt(jTextField9.getText());
             
             int code=JOptionPane.showConfirmDialog(this, "Are you Sure to Reserve ??", "Confirm Dialog Box", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
             
             if(code==JOptionPane.YES_OPTION)
             {
             String str="insert into reserve(room_no,room_type,status,rate,cust_id,cust_name,address,phone,e_mail,b_date,a_date,no_of_days,advance)values("+(roomno)+",'"+(roomtype)+"','"+(ava)+"',"+(customerID)+",'"+(customerName)+"','"+(customerAddress)+"',"+(phone)+",'"+(email)+"',"+(bookingDate)+","+(arrivingDate)+","+(noOfDays)+","+(adv)+");";
             ...
             String supdate="update rooms set available='booked'where room_no="+(jTextField1.getText())+";";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(manager_reserve_from.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
