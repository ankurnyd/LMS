    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Class.forName("java.sql.Driver");
             ...
             {
             String str="insert into reserve(room_no,room_type,status,rate,cust_id,cust_name,address,phone,e_mail,b_date,a_date,d_date,no_of_days,advance,nationality)values("+(roomno)+",'"+(roomtype)+"','"+(ava)+"',"+(roomrate)+","+(customerID)+",'"+(customerName)+"','"+(customerAddress)+"','"+(phone)+"','"+(email)+"',"+(bookingDate)+","+(arrivingDate)+","+(departureDate)+","+(noOfDays)+","+(adv)+",'"+(nation)+"');";
